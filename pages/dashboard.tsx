...
const Home = ({ selected, setSelected }: Props) => {
  ...
  useEffect(() => {
    ...
    signer &&
      ...
      console.log(network);
      setAdd(`${signer.address.substr(0, 6)}...${signer.address.substr(-4)}`);
  ...
  return (
    <Box m="0px" p="0em" position="relative" top="5" h="100%" bg="rgb(200, 200, 200)">
      <Tabs variant="solid-rounded" orientation="vertical" defaultIndex={1}>
        <TabList pl="0em" pr="1em" m="1em">
          <Flex mb="5.5em" mt="4.5em" alignItems="center" justifyContent="center">
            <Link href="/">
              <Heading className="h-shadow" fontFamily="Domine" color="black">BookVerse</Heading>
            </Link>
          </Flex>
          <Tab display="none"></Tab>
          <Tab 
            _selected={{bg: "#a101ff", color: "white"}} 
            _focus={{border: "none"}}
            mb="1em"
          >
        ...
        <TabPanels h="94vh" pb="0.5em"  bg="whitesmoke" overflow="scroll">
          <Box mb="1em">
          ...
          <TabPanel mx="1.5em">
            <Box mt="4em">
              <Heading fontSize="26px" fontFamily="Montserrat">Recent Launches</Heading>
              ...
              <Heading mt="3em" fontSize="26px" fontFamily="Montserrat">Best Sellers</Heading>
          ...
          <TabPanel>
            <Box mt="4em">
              <Flex rounded="10px" bg="rgb(234, 234, 234)" p="2em" px="5em" justifyContent="center" flexDir="column" alignItems="center">
                <Image src={"/deal.gif"} height={200} width={200}></Image>
                <Box align="center">
            ...
            <Box mt="4em">
              {booksPublishedInDesk.length 
                ...
                <Flex mt="9em" justifyContent="center" flexDir="column" alignItems="center">
                  <Image src={"/no-results.gif"} height={180} width={180} />
