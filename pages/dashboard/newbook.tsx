...
import { eBook, publish } from "../../src/controllers/eBookMarketLaunch";
...
import PreviewBook from "../../src/components/common/PreviewBook";
        ...
        <section className="w-screen h-screen px-60 py-8">
          ...
          >
            ...
            <div className="w-full h-full flex flex-col justify-center space-y-5">
              <Heading fontFamily="Montserrat" className="w-full text-2xl font-bold">
                Book Details
              </Heading>
              <input
                type="text"
